...
public class post {
    ...
    private String pid,platform_id, region_id, reply_count, screen_name, title_id;

    public post(String body, String mii,painting painting, String reply_count, String title_id, String created_at, String screen_name) {
        this.body = body;
