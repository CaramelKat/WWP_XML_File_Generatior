public class topic {
    ...
    public topic(String icon, String title_id, String community_id, String is_recommended, String name, String participant_count, String has_shop_page, String modified_at, person... people) {
        this.icon = icon;
